...
var TimelineElementsHeader = function (_Component) {
  ...
  function TimelineElementsHeader(props) {
    ...
    _this.handlePeriodClick = function (time, unit) {
      var _this$context$getZoom = _this.context.getZoomState(),
          enableZoom = _this$context$getZoom.enableZoom;
  ...
  _createClass(TimelineElementsHeader, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          subHeaderLabelRenderer = _props.subHeaderLabelRenderer;
      ...
      (0, _calendar.iterateTimes)(canvasTimeStart, canvasTimeEnd, minUnit, timeSteps, function (time, nextTime) {
        ...
        var bottomLabel = _this2.subHeaderLabel(time, minUnit, labelWidth);
        ...
        bottomHeaderLabels.push(_react2.default.createElement(
          ...
          subHeaderLabelRenderer && subHeaderLabelRenderer({ label: bottomLabel, time: time, minUnit: minUnit, labelWidth: labelWidth }) || bottomLabel
        ));
      });
...
TimelineElementsHeader.propTypes = {
  ...
  subHeaderLabelRenderer: _propTypes2.default.func
};
TimelineElementsHeader.contextType = _TimelineStateContext.TimelineStateConsumer;
